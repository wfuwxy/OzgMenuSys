...
namespace InformationDesk
{
    public class AppConfig
    {
        ...
        public static string CLIENT_WANT_REPORT_MONTH = "CLIENT_WANT_REPORT_MONTH";
        ...
        public static string CLIENT_WANT_ORDER_DETAIL = "CLIENT_WANT_ORDER_DETAIL";
        ...
        public static string SERV_REPORT_MONTH = "SERV_REPORT_MONTH";
        ...
        public static string SERV_ORDER_DETAIL = "SERV_ORDER_DETAIL";
        public static string SERV_ORDER_DETAIL_CHANGE_STATUS = "SERV_ORDER_DETAIL_CHANGE_STATUS";   
